...
The basis for this paper is a project developed by data science students at UC Berkeley: [\textcolor{blue}{Renzee Reyes}](https://www.ischool.berkeley.edu/people/renzee-reyes), [\textcolor{blue}{Tim Witthoefft}](https://www.ischool.berkeley.edu/people/tim-witthoefft), [\textcolor{blue}{Jack Workman}](https://www.ischool.berkeley.edu/people/jack-workman) and [\textcolor{blue}{Yulia Zamriy}](https://www.ischool.berkeley.edu/people/yulia-zamriy). 

Project documentation can be found on [\textcolor{blue}{GitHub}](https://github.com/YuliaZamriy/W207_Group_Project).

I would like to thank [\textcolor{blue}{Jordan Berke}](https://www.linkedin.com/in/jordan-berke-7ab700ab/), co-founder at [\textcolor{blue}{RepOne Strength}](https://www.reponestrength.com/), who supported the project and provided feedback on this paper.
...
Our first workable solution for bench press consists of three clusters of lifters with 57, 116 and 117 members in each (they are captured by the chart above). Four standardized metrics were used to form these clusters: `Peak Velocity`, `Peak Velocity Location`, `Rep Duration` and `Lifted Weight`. 
